...
void Application::initWindow() {
  ...
  // Do not initialize OpenGL - Vulkan does it other way
...
void Application::createSwapChain() {
  ...
  // FIXME: use VK_IMAGE_USAGE_TRANSFER_DST_BIT for this engine?
  ...
  if (indices.graphicsFamily != indices.presentFamily) {
    createInfo.imageSharingMode = VK_SHARING_MODE_CONCURRENT;  // FIXME: move to exclusive in future?
...
void Application::createRenderPass() {
  ...
  colorAttachment.loadOp = VK_ATTACHMENT_LOAD_OP_CLEAR;  // FIXME probably change to preserve
